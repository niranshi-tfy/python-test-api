...
try:
    response = requests.post(
        "http://localhost:5002/api/inference/openai/completions",
        headers = {
            "Authorization": "Bearer yJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImd0eSI6WyJhdXRob3JpemF0aW9uX2NvZGUiXSwia2lkIjoibHNXSUM1a2RTVXVteDVySDk2RHpsV1hQbElNIn0..caBZSpeTD34sq7V6GXohhDCGrLz-hi9oP6YB6fgYDDGvjPiYmo9SIHKwNmIMOO3r9kmZE-1YQsvZ0uw99dtPnyDejDVAFiOVH6_y4kXdQ0L-UvqqfH8uOLbjwnJcaGxdjtSUlZgWTo0nNkX1yPIOF_ykl82NbEw6vkrO_mLhmEhC6_VsoFqasLCVAJ9PZSssGGcmQBR0QBgSUw37PAdUqnmxoCvaaARjaBfDXqB2zFmnz1-rNXnahTbylOZViJSKPIx8T74jhl0zPx1q9eIRDgrRhLHSo0P4yHUgsFCgnwxzMbwa9MCCx_SbqbJo9zb1VSP5hL727sDHuxCxPgzhrw",
        },
        json = {
            "model":"truefoundry-public/Llama-2(7B)",
            "prompt": "Enter your prompt here",
...
# response = requests.post(
#     "http://localhost:5002/api/inference/text/stream",
#     headers = {
#         "Authorization": "Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImd0eSI6WyJhdXRob3JpemF0aW9uX2NvZGUiXSwia2lkIjoibHNXSUM1a2RTVXVteDVySDk2RHpsV1hQbElNIn0..caBZSpeTD34sq7V6GXohhDCGrLz-hi9oP6YB6fgYDDGvjPiYmo9SIHKwNmIMOO3r9kmZE-1YQsvZ0uw99dtPnyDejDVAFiOVH6_y4kXdQ0L-UvqqfH8uOLbjwnJcaGxdjtSUlZgWTo0nNkX1yPIOF_ykl82NbEw6vkrO_mLhmEhC6_VsoFqasLCVAJ9PZSssGGcmQBR0QBgSUw37PAdUqnmxoCvaaARjaBfDXqB2zFmnz1-rNXnahTbylOZViJSKPIx8T74jhl0zPx1q9eIRDgrRhLHSo0P4yHUgsFCgnwxzMbwa9MCCx_SbqbJo9zb1VSP5hL727sDHuxCxPgzhrw",
#     },
#     json = {
...
#         "model":
#                 {
#                     "name": "openai-main/text-davinci-003",
#                     "parameters": {
#                         "temperature": 0.5,
#                         "maximum_length": 200,
#                         "top_p": 1.0,
...
# for event in client.events():
#     print("yooo")
#     if json.loads(event.data)["message"] not in ['[INITIALIZING]', '[COMPLETED]']:
#        print(json.loads(event.data)["message"], end="", flush=True)
...
response = requests.post(
    "http://localhost:5002/api/inference/text/stream",
    headers = {
        "Authorization": "Bearer eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCIsImd0eSI6WyJhdXRob3JpemF0aW9uX2NvZGUiXSwia2lkIjoibHNXSUM1a2RTVXVteDVySDk2RHpsV1hQbElNIn0..XyXNl8Yfpe749Lvebey7tVMPWQkZ2CHBinnrIGtsCTY6xCdSIbWMt8qX_uUq6u9eJqZmtdPZGYxpgssOe1KWH3EEg4RSeps8VW_cv_X5ZDR8eGxYhSxcLNbdbqI69EH_eLiHtmHoUhtFVxVU2M32SBTWHBK9BqHmsGvGsvBceNYK3K2RfbKJVqjtLlpVeLCkCfee3aRtdYYchfElULGz6me69_iFAXjd9suMeqXPwh6I0yRzh9DdR8r5p-NUCiMOBEDHzZPKDXXYiA7cw98La15XfiNPw0yKSbtY-xkvsnY3fFNa612oaRlh_JddmtAk5Vg-vFHSgW97GqqP-mNNuw",
    },
    json = {
        "prompt": "### Instruction:\n You will be presented with list of news articles. Your task is to analyze the content of the article's description and determine whether it is primarily about the specified company. The company in question for this task is Notion, and a description about the company is Notion is a connected workspace that combines wiki, docs, and project management tools into one platform. It provides an all-in-one workspace for tasks, notes, wikis, and calendars. With Notion, users can centralize their knowledge, manage complex proj..., url of the company is notion.so. Instructions: Carefully read each news article's description in its entirety. Identify Key Themes: Note the main themes, topics, and subjects discussed in the article. Company References: Look for direct references to Notion using the description Notion is a connected workspace that combines wiki, docs, and project management tools into one platform. It provides an all-in-one workspace for tasks, notes, wikis, and calendars. With Notion, users can centralize their knowledge, manage complex proj..., including mentions of its products, services, leadership, financial performance, strategic decisions, or any news specifically impacting the company using the name and description given to you. Context Analysis: Evaluate the context in which Notion is mentioned. Determine if the company is the central focus of the article or just a minor element in a broader topic and also if the article description matches Notion is a connected workspace that combines wiki, docs, and project management tools into one platform. It provides an all-in-one workspace for tasks, notes, wikis, and calendars. With Notion, users can centralize their knowledge, manage complex proj.... Related Entities: Identify if other entities (companies, organizations, individuals) are mentioned and assess their relevance to Notion. Conclusion: Based on your analysis, conclude whether the article is primarily about Notion or not. Article for Analysis: [ { description: \\\"The Patriots showed little creativity or spunk on offense and looked like they are perfectly content playing out the string to wrap up the season.\\\", },{ description: \\\"The district attorney prosecuting Donald Trump over efforts to overturn the 2020 election in Georgia says it's a \"silly notion\" that the former president's case should be paused just because he's runn\\\", },{ description: \\\"Despite losing three of their last four games during the regular season, the Bruins re-grouped and came away with the win in their bowl game. But head coach Chip Kelly dismissed the notion that this win redeemed the team for their struggles this season.\\\", },{ description: \\\"Analytics show that the Spurs forward held the NBA's all-time scoring leader without a point, but Popovich isn't buying it.\\\", },{ description: \\\"The Georgia prosecutor leading the case in the state against former President Trump wrote off his attorneys' attempts to delay the case against him due to the 2024 election as a \"silly notion,\"\\\", },{ description: \\\"Fani Willis has alleged that Trump, lawyer Rudy Giuliani and others participated in a scheme to overturn the 2020 election results after voters elected Democrat Joe Biden as president.\\\", },{ description: \\\"In the evolving digital age, the security of our online workspaces is paramount. Anytype and Notion, two giants in the realm of digital organization and productivity, offer unique approaches to ...\\\", },{ description: \\\"Roula Khalaf, Editor of the FT, selects her favourite stories in this weekly newsletter. This week's rally in global bond markets has shattered investors' months-long assumption that interest ...\\\", },{ description: \\\"\"If the prosecutor finds that they violated the law, they have an ethical duty to bring forth charges and so this is a silly notion to me that because one runs from office that your criminal ...\\\", } ] Response: Parse through all the articles and return true for articles which are primarily about Notion and false if the article does not belong to the Notion, return the response in the array of true or false and valid array of booleans and nothing else. Sample response examples are [true, false, true,,.....]. \n\nReturn only the boolean array and no other text.\n\n### Response:\n",
        "model":
                {
                    "name": "truefoundry-public/Nous-Hermes-Llama2(13B)",
                    "parameters": {
                        "temperature": 0.7,
                        "maximum_length": 512,
                        "top_p": 0.7,
...
for event in client.events():
  if event.data != "[DONE]":
    cnt+=1
    # print(json.loads(event.data)["message"], end="")
    duration = (time.time()- new_strt)
    print(duration)
    total += duration
    new_strt=time.time()
print(cnt)
